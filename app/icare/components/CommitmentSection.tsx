...
export const CommitmentSection: React.FC<CommitmentSectionProps> = ({ lang, onNavigate }) => {
  ...
  const pillBase = 'relative isolate inline-flex items-center justify-center overflow-hidden rounded-full border border-[#67645E] px-8 py-2.5 text-[13px] font-bold uppercase leading-[1.5] tracking-[0.02em] text-[#67645E] transition-[color,transform,border-color] duration-500 ease-[cubic-bezier(0.76,0,0.24,1)] before:absolute before:inset-0 before:-z-10 before:origin-bottom before:scale-y-0 before:rounded-full before:bg-[#67645E] before:transition-transform before:duration-500 before:ease-[cubic-bezier(0.76,0,0.24,1)] hover:-translate-y-px hover:border-[#67645E] hover:text-white hover:before:scale-y-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#67645E] focus-visible:ring-offset-2 focus-visible:ring-offset-[#F1F0ED]';
