    ...
    <section className="icare-index-section icare-full-banner">
      ...
      <div className="icare-full-banner__copy">
        <motion.h2 
          ...
          className="m-0 text-[clamp(2rem,5vw,2.5rem)] font-black leading-none tracking-[-0.04em] lowercase text-white"
        >
          {philosophyHeadline}
        </motion.h2>
        ...
        <motion.p 
          ...
          className="m-0 max-w-2xl text-[15px] font-medium leading-[1.5] text-white/90 md:text-[16px]"
        >
          {philosophyText}
        </motion.p>
